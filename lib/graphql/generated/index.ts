...
/** Input for the createHomeSingleton mutation. */
export type CreateHomeSingletonInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
...
/** The payload for the createHomeSingleton mutation. */
export type CreateHomeSingletonPayload = {
  __typename?: 'CreateHomeSingletonPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  homeSingleton?: Maybe<HomeSingleton>;
};
...
/** Input for the createProyecto mutation. */
...
/** The payload for the createProyecto mutation. */
export type CreateProyectoPayload = {
  __typename?: 'CreateProyectoPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
...
/** Input for the deleteHomeSingleton mutation. */
export type DeleteHomeSingletonInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the homeSingleton to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteHomeSingleton mutation. */
export type DeleteHomeSingletonPayload = {
  __typename?: 'DeleteHomeSingletonPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
/** Input for the deleteProyecto mutation. */
export type DeleteProyectoInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the proyecto to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteProyecto mutation. */
export type DeleteProyectoPayload = {
  __typename?: 'DeleteProyectoPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
/** The homeSingleton type */
export type HomeSingleton = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'HomeSingleton';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<HomeSingletonToHomeSingletonConnection>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the home-singleton object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** [JetEngine scalar] hero_cta_label */
  heroCtaLabel?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] hero_cta_message */
  heroCtaMessage?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] hero_eyebrow */
  heroEyebrow?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] hero_image */
  heroImage?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] hero_image_caption */
  heroImageCaption?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] hero_subtitle */
  heroSubtitle?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] hero_title */
  heroTitle?: Maybe<Scalars['String']['output']>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  homeSingletonId: Scalars['Int']['output'];
  /** The globally unique identifier of the home-singleton object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
   ...
   */
  parent?: Maybe<HomeSingletonToParentConnectionEdge>;
  /** The password for the home-singleton object. */
  password?: Maybe<Scalars['String']['output']>;
  /** Connection between the homeSingleton type and the homeSingleton type */
  preview?: Maybe<HomeSingletonToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
  /** [JetEngine repeater-&gt;JSON] problems_cards */
  problemsCards?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] problems_eyebrow */
  problemsEyebrow?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] problems_subtitle */
  problemsSubtitle?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] problems_title */
  problemsTitle?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] process_cta_label */
  processCtaLabel?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] process_eyebrow */
  processEyebrow?: Maybe<Scalars['String']['output']>;
  /** [JetEngine repeater-&gt;JSON] process_rotating_words */
  processRotatingWords?: Maybe<Scalars['String']['output']>;
  /** [JetEngine repeater-&gt;JSON] process_steps */
  processSteps?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] process_subtitle */
  processSubtitle?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] process_title_prefix_f */
  processTitlePrefixF?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] process_title_prefix_m */
  processTitlePrefixM?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] process_title_suffix */
  processTitleSuffix?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] reels_cta_button */
  reelsCtaButton?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] reels_cta_text */
  reelsCtaText?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] reels_eyebrow */
  reelsEyebrow?: Maybe<Scalars['String']['output']>;
  /** [JetEngine repeater-&gt;JSON] reels_selected */
  reelsSelected?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] reels_subtitle */
  reelsSubtitle?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] reels_title */
  reelsTitle?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] reels_whatsapp_message */
  reelsWhatsappMessage?: Maybe<Scalars['String']['output']>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug?: Maybe<Scalars['String']['output']>;
  /** The current status of the object */
  status?: Maybe<Scalars['String']['output']>;
...
/** The homeSingleton type */
export type HomeSingletonAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The homeSingleton type */
export type HomeSingletonContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The homeSingleton type */
export type HomeSingletonEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The homeSingleton type */
export type HomeSingletonEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The homeSingleton type */
export type HomeSingletonTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** A paginated collection of homeSingleton Nodes, Supports cursor-based pagination and filtering to efficiently retrieve sets of homeSingleton Nodes */
export type HomeSingletonConnection = {
  /** A list of edges (relational context) between RootQuery and connected homeSingleton Nodes */
  edges: Array<HomeSingletonConnectionEdge>;
  /** A list of connected homeSingleton Nodes */
  nodes: Array<HomeSingleton>;
  /** Information about pagination in a connection. */
  pageInfo: HomeSingletonConnectionPageInfo;
};

/** Represents a connection to a homeSingleton. Contains both the homeSingleton Node and metadata about the relationship. */
export type HomeSingletonConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected homeSingleton Node */
  node: HomeSingleton;
};

/** Pagination metadata specific to &quot;HomeSingletonConnectionEdge&quot; collections. Provides cursors and flags for navigating through sets of &quot;HomeSingletonConnectionEdge&quot; Nodes. */
export type HomeSingletonConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Identifier types for retrieving a specific HomeSingleton. Specifies which unique attribute is used to find an exact HomeSingleton. */
export enum HomeSingletonIdType {
  /** Identify a resource by the Database ID. */
  DatabaseId = 'DATABASE_ID',
  /** Identify a resource by the (hashed) Global ID. */
  Id = 'ID',
...
/** Connection between the homeSingleton type and the homeSingleton type */
export type HomeSingletonToHomeSingletonConnection = Connection & HomeSingletonConnection & {
  __typename?: 'HomeSingletonToHomeSingletonConnection';
  /** Edges for the HomeSingletonToHomeSingletonConnection connection */
  edges: Array<HomeSingletonToHomeSingletonConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<HomeSingleton>;
  /** Information about pagination in a connection. */
  pageInfo: HomeSingletonToHomeSingletonConnectionPageInfo;
};

/** An edge in a connection */
export type HomeSingletonToHomeSingletonConnectionEdge = Edge & HomeSingletonConnectionEdge & {
  __typename?: 'HomeSingletonToHomeSingletonConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Pagination metadata specific to &quot;HomeSingletonToHomeSingletonConnection&quot; collections. Provides cursors and flags for navigating through sets of HomeSingletonToHomeSingletonConnection Nodes. */
export type HomeSingletonToHomeSingletonConnectionPageInfo = HomeSingletonConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'HomeSingletonToHomeSingletonConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the homeSingleton type and the homeSingleton type */
export type HomeSingletonToParentConnectionEdge = Edge & HomeSingletonConnectionEdge & OneToOneConnection & {
  __typename?: 'HomeSingletonToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the homeSingleton type and the homeSingleton type */
export type HomeSingletonToPreviewConnectionEdge = Edge & HomeSingletonConnectionEdge & OneToOneConnection & {
  __typename?: 'HomeSingletonToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: HomeSingleton;
...
export type MenuItemObjectUnion = Category | HomeSingleton | Page | Post | PostFormat | Proyecto | Tag;
...
/** The proyecto type */
export type Proyecto = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Proyecto';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<ProyectoToProyectoConnection>;
  /** [JetEngine scalar] benefit */
  benefit?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] client_problem */
  clientProblem?: Maybe<Scalars['String']['output']>;
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the proyectos object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the proyectos object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
  ...
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] original_url */
  originalUrl?: Maybe<Scalars['String']['output']>;
  /**
   * The parent of the content node.
   * @deprecated This content type is not hierarchical and typically will not have a parent
   */
  parent?: Maybe<ProyectoToParentConnectionEdge>;
  /** The password for the proyectos object. */
  password?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] platform */
  platform?: Maybe<Scalars['String']['output']>;
  /** Connection between the proyecto type and the proyecto type */
  preview?: Maybe<ProyectoToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  proyectoId: Scalars['Int']['output'];
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] solution */
  solution?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] solution_summary */
  solutionSummary?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] space_type */
  ...
  /** The unique resource identifier path */
  uri?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] video */
  video?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] video_alt */
  videoAlt?: Maybe<Scalars['String']['output']>;
  /** [JetEngine scalar] video_poster */
  videoPoster?: Maybe<Scalars['String']['output']>;
};


/** The proyecto type */
export type ProyectoAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The proyecto type */
export type ProyectoContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The proyecto type */
export type ProyectoEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The proyecto type */
export type ProyectoEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The proyecto type */
export type ProyectoTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** A paginated collection of proyecto Nodes, Supports cursor-based pagination and filtering to efficiently retrieve sets of proyecto Nodes */
export type ProyectoConnection = {
  /** A list of edges (relational context) between RootQuery and connected proyecto Nodes */
  edges: Array<ProyectoConnectionEdge>;
  /** A list of connected proyecto Nodes */
  nodes: Array<Proyecto>;
  /** Information about pagination in a connection. */
  pageInfo: ProyectoConnectionPageInfo;
};

/** Represents a connection to a proyecto. Contains both the proyecto Node and metadata about the relationship. */
export type ProyectoConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected proyecto Node */
  node: Proyecto;
};

/** Pagination metadata specific to &quot;ProyectoConnectionEdge&quot; collections. Provides cursors and flags for navigating through sets of &quot;ProyectoConnectionEdge&quot; Nodes. */
export type ProyectoConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Identifier types for retrieving a specific Proyecto. Specifies which unique attribute is used to find an exact Proyecto. */
export enum ProyectoIdType {
  /** Identify a resource by the Database ID. */
  DatabaseId = 'DATABASE_ID',
  /** Identify a resource by the (hashed) Global ID. */
  Id = 'ID',
...
/** Connection between the proyecto type and the proyecto type */
export type ProyectoToParentConnectionEdge = Edge & OneToOneConnection & ProyectoConnectionEdge & {
  __typename?: 'ProyectoToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the proyecto type and the proyecto type */
export type ProyectoToPreviewConnectionEdge = Edge & OneToOneConnection & ProyectoConnectionEdge & {
  __typename?: 'ProyectoToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Proyecto;
...
/** Connection between the proyecto type and the proyecto type */
export type ProyectoToProyectoConnection = Connection & ProyectoConnection & {
  __typename?: 'ProyectoToProyectoConnection';
  /** Edges for the ProyectoToProyectoConnection connection */
  edges: Array<ProyectoToProyectoConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Proyecto>;
  /** Information about pagination in a connection. */
  pageInfo: ProyectoToProyectoConnectionPageInfo;
};

/** An edge in a connection */
export type ProyectoToProyectoConnectionEdge = Edge & ProyectoConnectionEdge & {
  __typename?: 'ProyectoToProyectoConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Pagination metadata specific to &quot;ProyectoToProyectoConnection&quot; collections. Provides cursors and flags for navigating through sets of ProyectoToProyectoConnection Nodes. */
export type ProyectoToProyectoConnectionPageInfo = PageInfo & ProyectoConnectionPageInfo & WpPageInfo & {
  __typename?: 'ProyectoToProyectoConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
export type RootMutation = {
  ...
  /** The createHomeSingleton mutation */
  createHomeSingleton?: Maybe<CreateHomeSingletonPayload>;
  ...
  /** The createProyecto mutation */
  createProyecto?: Maybe<CreateProyectoPayload>;
  ...
  /** The deleteHomeSingleton mutation */
  deleteHomeSingleton?: Maybe<DeleteHomeSingletonPayload>;
  ...
  /** The deleteProyecto mutation */
  deleteProyecto?: Maybe<DeleteProyectoPayload>;
  ...
  /** The updateHomeSingleton mutation */
  updateHomeSingleton?: Maybe<UpdateHomeSingletonPayload>;
  ...
  /** The updateProyecto mutation */
  updateProyecto?: Maybe<UpdateProyectoPayload>;
...
/** The root mutation */
export type RootMutationCreateHomeSingletonArgs = {
  input: CreateHomeSingletonInput;
};
...
/** The root mutation */
export type RootMutationCreateProyectoArgs = {
...
/** The root mutation */
export type RootMutationDeleteHomeSingletonArgs = {
  input: DeleteHomeSingletonInput;
};
...
/** The root mutation */
export type RootMutationDeleteProyectoArgs = {
...
/** The root mutation */
export type RootMutationUpdateHomeSingletonArgs = {
  input: UpdateHomeSingletonInput;
};
...
/** The root mutation */
export type RootMutationUpdateProyectoArgs = {
...
export type RootQuery = {
  ...
  homeSingleton?: Maybe<HomeSingleton>;
  /**
   * A homeSingleton object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  homeSingletonBy?: Maybe<HomeSingleton>;
  /** Connection between the RootQuery type and the homeSingleton type */
  homeSingletons?: Maybe<RootQueryToHomeSingletonConnection>;
  ...
  /** An object of the proyecto Type.  */
  proyecto?: Maybe<Proyecto>;
  /**
   * A proyecto object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  proyectoBy?: Maybe<Proyecto>;
  /** Connection between the RootQuery type and the proyecto type */
  proyectos?: Maybe<RootQueryToProyectoConnection>;
...
/** The root entry point into the Graph */
export type RootQueryHomeSingletonArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<HomeSingletonIdType>;
};


/** The root entry point into the Graph */
export type RootQueryHomeSingletonByArgs = {
  homeSingletonId?: InputMaybe<Scalars['Int']['input']>;
  id?: InputMaybe<Scalars['ID']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
...
/** The root entry point into the Graph */
export type RootQueryHomeSingletonsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToHomeSingletonConnectionWhereArgs>;
};
...
/** The root entry point into the Graph */
export type RootQueryProyectoArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<ProyectoIdType>;
};


/** The root entry point into the Graph */
export type RootQueryProyectoByArgs = {
  id?: InputMaybe<Scalars['ID']['input']>;
  proyectoId?: InputMaybe<Scalars['Int']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
  uri?: InputMaybe<Scalars['String']['input']>;
};
...
/** The root entry point into the Graph */
export type RootQueryProyectosArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToProyectoConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the homeSingleton type */
export type RootQueryToHomeSingletonConnection = Connection & HomeSingletonConnection & {
  __typename?: 'RootQueryToHomeSingletonConnection';
  /** Edges for the RootQueryToHomeSingletonConnection connection */
  edges: Array<RootQueryToHomeSingletonConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<HomeSingleton>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToHomeSingletonConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToHomeSingletonConnectionEdge = Edge & HomeSingletonConnectionEdge & {
  __typename?: 'RootQueryToHomeSingletonConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: HomeSingleton;
...
/** Pagination metadata specific to &quot;RootQueryToHomeSingletonConnection&quot; collections. Provides cursors and flags for navigating through sets of RootQueryToHomeSingletonConnection Nodes. */
export type RootQueryToHomeSingletonConnectionPageInfo = HomeSingletonConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToHomeSingletonConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToHomeSingletonConnection connection */
export type RootQueryToHomeSingletonConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Connection between the RootQuery type and the proyecto type */
export type RootQueryToProyectoConnection = Connection & ProyectoConnection & {
  __typename?: 'RootQueryToProyectoConnection';
  /** Edges for the RootQueryToProyectoConnection connection */
  edges: Array<RootQueryToProyectoConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Proyecto>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToProyectoConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToProyectoConnectionEdge = Edge & ProyectoConnectionEdge & {
  __typename?: 'RootQueryToProyectoConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Proyecto;
...
/** Pagination metadata specific to &quot;RootQueryToProyectoConnection&quot; collections. Provides cursors and flags for navigating through sets of RootQueryToProyectoConnection Nodes. */
export type RootQueryToProyectoConnectionPageInfo = PageInfo & ProyectoConnectionPageInfo & WpPageInfo & {
  __typename?: 'RootQueryToProyectoConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToProyectoConnection connection */
export type RootQueryToProyectoConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Input for the updateHomeSingleton mutation. */
export type UpdateHomeSingletonInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The content of the object */
  content?: InputMaybe<Scalars['String']['input']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the homeSingleton object */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updateHomeSingleton mutation. */
export type UpdateHomeSingletonPayload = {
  __typename?: 'UpdateHomeSingletonPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  homeSingleton?: Maybe<HomeSingleton>;
...
/** Input for the updateProyecto mutation. */
...
/** The payload for the updateProyecto mutation. */
export type UpdateProyectoPayload = {
  __typename?: 'UpdateProyectoPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  proyecto?: Maybe<Proyecto>;
...
export type GetHomeQuery = { __typename?: 'RootQuery', homeSingletons?: { __typename?: 'RootQueryToHomeSingletonConnection', nodes: Array<{ __typename?: 'HomeSingleton', id: string, heroEyebrow?: string | null | undefined, heroTitle?: string | null | undefined, heroSubtitle?: string | null | undefined, heroImage?: string | null | undefined, heroImageCaption?: string | null | undefined, heroCtaLabel?: string | null | undefined, heroCtaMessage?: string | null | undefined, problemsEyebrow?: string | null | undefined, problemsTitle?: string | null | undefined, problemsSubtitle?: string | null | undefined, problemsCards?: string | null | undefined, reelsEyebrow?: string | null | undefined, reelsTitle?: string | null | undefined, reelsSubtitle?: string | null | undefined, reelsSelected?: string | null | undefined, reelsCtaText?: string | null | undefined, reelsCtaButton?: string | null | undefined, reelsWhatsappMessage?: string | null | undefined, processEyebrow?: string | null | undefined, processTitlePrefixM?: string | null | undefined, processTitlePrefixF?: string | null | undefined, processTitleSuffix?: string | null | undefined, processRotatingWords?: string | null | undefined, processSubtitle?: string | null | undefined, processCtaLabel?: string | null | undefined, processSteps?: string | null | undefined }> } | null | undefined };

export type GetMediaUrlsQueryVariables = Exact<{
  ids: Array<InputMaybe<Scalars['ID']['input']>> | InputMaybe<Scalars['ID']['input']>;
}>;


export type GetMediaUrlsQuery = { __typename?: 'RootQuery', mediaItems?: { __typename?: 'RootQueryToMediaItemConnection', nodes: Array<{ __typename?: 'MediaItem', databaseId: number, mediaItemUrl?: string | null | undefined, sourceUrl?: string | null | undefined }> } | null | undefined };

export type GetProyectosQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProyectosQuery = { __typename?: 'RootQuery', proyectos?: { __typename?: 'RootQueryToProyectoConnection', nodes: Array<{ __typename?: 'Proyecto', id: string, databaseId: number, title?: string | null | undefined, slug?: string | null | undefined, video?: string | null | undefined, videoPoster?: string | null | undefined, videoAlt?: string | null | undefined, platform?: string | null | undefined, originalUrl?: string | null | undefined, spaceType?: string | null | undefined, clientProblem?: string | null | undefined, solution?: string | null | undefined, benefit?: string | null | undefined, solutionSummary?: string | null | undefined }> } | null | undefined };
...
export const GetMediaUrlsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetMediaUrls"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"ids"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"mediaItems"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"100"}},{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"in"},"value":{"kind":"Variable","name":{"kind":"Name","value":"ids"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"databaseId"}},{"kind":"Field","name":{"kind":"Name","value":"mediaItemUrl"}},{"kind":"Field","name":{"kind":"Name","value":"sourceUrl"}}]}}]}}]}}]} as unknown as DocumentNode<GetMediaUrlsQuery, GetMediaUrlsQueryVariables>;
